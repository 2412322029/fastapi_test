        ...
        <div class="flex items-center min-w-max absolute left-1/2 top-1/3 translate-x-[-50%] translate-y-[-50%]">
            <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8 w-full">
                <div class="w-full max-w-md space-y-8">
                    <div>
                        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">register your account
                        </h2>
                    </div>
                    <form class="mt-8 space-y-6" action="#" method="POST">
                        <div class="-space-y-px rounded-md shadow-sm">
                            ...
                            <div>
                                ...
                                <input id="password2" :class="{ 'focus:ring-red-600': !ck2(),'focus:ring-green-600': ck2() }" name="password" type="password" autocomplete="current-password" v-model="password_agine"
                                    required
                        ...
                        <div class="flex items-center justify-between">
                            <div class="text-sm">
                                <a href="./login" class="font-medium text-indigo-600 hover:text-indigo-500">Back to sing up</a>
                            </div>
